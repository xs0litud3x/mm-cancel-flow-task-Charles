...
async function completeNoMM(formData: FormData) {
  'use server';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
            ...
            <div>
              <h1 className="text-[22px] lg:text-[24px] font-semibold text-gray-900">
                You landed the job! <span className="italic">That’s what we live for.</span>
              </h1>
            ...
            {/* Right image (no profile/avatar on this page) */}
